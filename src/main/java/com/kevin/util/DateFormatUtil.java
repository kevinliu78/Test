...
public class DateFormatUtil {
     ...
     * @Description 获取指定日期当天零点时间
     * @Author Liuws
     * @Date 2024-03-18 16:17
     */
    public synchronized static Date getZeroDateByDay(Date date) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @param date
     * @return java.util.Date
     * @Description 获取指定日期后一天零点时间
     * @Author Liuws
     * @Date 2024-03-18 16:22
     */
    public synchronized static Date getNextDayZeroDateByDay(Date date) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        calendar.set(Calendar.HOUR_OF_DAY, 0);
        calendar.set(Calendar.MINUTE, 0);
