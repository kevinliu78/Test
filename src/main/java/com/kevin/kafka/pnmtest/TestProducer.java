...
/**
 * @author kevin
 * @version 创建时间: 2018年9月14日上午8:52:23
 * @ClassName 类名称
 * @Description 类描述
 */
public class TestProducer {
	public static void main(String[] args) {
        ...
        props.put("bootstrap.servers", "192.168.22.200:9092,192.168.22.201:9092,192.168.22.202:9092");
        props.put("acks", "all");
        props.put("retries", 0);
        ...
        //生产者发送消息 
        String topic = "topic_cmPredataBean_14_GDS_GZS_02";
...
//        }
        ...
        for (int i = 1; i <= 1; i++) {
        		ProducerRecord<String, String> msg = new ProducerRecord<String, String>(topic, cmNode());
            procuder.send(msg);
        }
        //列出topic的相关信息
