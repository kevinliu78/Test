...
/**
 * @author kevin
 * @version 创建时间: 2018年9月13日下午3:26:45
 * @ClassName 类名称
 * @Description 类描述
 */
public class Test {
	//cmts 基本信息 主题
    public static final String TOPIC_CMTSCHASSISBEAN = "topic_cmtsChassisBean_%s_%s";
    //cmts 上下行通道
    public static final String TOPIC_CMTSCHANNELBEAN = "topic_cmtsChannelBean_%s_%s";
    // cm 基本信息
    public static final String TOPIC_CMPREDATABEAN = "topic_cmPredataBean_%s_%s";
    //实时消息收发主题
    //topic_realtime_to_14_GDS_GZS  (topic_realtime_to_emsCode_cityCode)
    //topic_realtime_from_14_GDS_GZS
    public static final String TOPIC_REALTIME_TO = "topic_realtime_to_%s_%s";
    public static final String TOPIC_REALTIME_FROM = "topic_realtime_from_%s_%s";
    //心跳主题
    public static final String TOPIC_HEARTBEAT = "topic_heartbeat_%s_%s";
    //同步网格关系主题
    public static final String TOPIC_SYNCRELATION = "topic_syncRelation_%s_%s";
    
	public static void main(String[] args) {
//		String topic = String.format(TOPIC_CMPREDATABEAN, 14,"GDS_GZS_01");
		String topic = "topic_cmPredataBean_14_GDS_GZS_01";
		String data = cmNode();
		Producer producer = new Producer(topic, true);
		producer.send("aaaaa");
//		CMConsumer consumer = new CMConsumer(topic, topic+"_consumer");
//		consumer.start();
	}
	...
	public static String cmNode() {
		...
		data.put("mac", "a1b2c3d4e5f6");
		data.put("ip", "10.177.18.247");
