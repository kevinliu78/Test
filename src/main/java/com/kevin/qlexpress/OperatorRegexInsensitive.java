 ...
 */
public class OperatorRegexInsensitive extends Operator {

    private static final Logger logger = LoggerFactory.getLogger(OperatorRegexInsensitive.class);

    public OperatorRegexInsensitive(String name) {
        this.name = name;
    }

    public OperatorRegexInsensitive(String aAliasName, String aName, String aErrorInfo) {
        this.name = aName;
    ...
    public Object executeInner(Object[] list) throws Exception {
        ...
        if (o1 instanceof String && o2 instanceof String) {
            ...
            regex = ".*" + regex + ".*";
            //不区分大小写
            result = Pattern.matches(regex.toLowerCase(), src.toLowerCase());
