...
public class SimpleConsumerDemo {
    ...
    private static void generateData() {
        Producer producer2 = new Producer(KafkaProperties.TOPIC1, false);
        producer2.start();
        Producer producer3 = new Producer(KafkaProperties.TOPIC1, false);
        producer3.start();
        try {
            Thread.sleep(1000);
    ...
    public static void main(String[] args) throws Exception {
        ...
        FetchRequest req = new FetchRequestBuilder()
            .clientId("")
            .addFetch(KafkaProperties.TOPIC1, 0, 0L, 100)
            .build();
