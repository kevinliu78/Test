package com.pbn.kevin.consistencyhashing;
...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        addressList.add("192.168.0.0:111");
        addressList.add("192.168.0.1:111");
        addressList.add("192.168.0.2:111");
//        addressList.add("192.168.0.3:111");
//        addressList.add("192.168.0.4:111");
    ...
    public static String hashJob(int jobId, List<String> addressList) {
        ...
        // ------A1------A2-------A3------
        // -----------J1------------------
        SortedMap<Long, String> addressRing = new TreeMap<Long, String>();
        ...
        return addressRing.get(addressRing.firstKey());
    }
}
